          ...
          <div class="col-md-7">
            ...
            <form  @submit.prevent="submitting === false && registerUser()">
              <div class="form-group first">
                ...
                <input type="text" class="form-control" placeholder="your-email@gmail.com" id="username" v-model="name" >
              </div>

              <div class="form-group first">
                <label for="username">Username</label>
                <input type="text" class="form-control" placeholder="your-email@gmail.com" id="username" v-model="username">
              </div>
            ...
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h3>Register</h3>
                    <p>Don't have an account? <router-link to="/auth/login">Sign in</router-link></p>
                  </div>
                </div>
              </div>
                ...
                <div class="row gy-3 overflow-hidden">
                   ...
                   <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="name" id="name" placeholder="user" v-model="name" required>
                   ...
                   <div class="col-12">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" name="text" id="name" placeholder="user" v-model="username" required>
