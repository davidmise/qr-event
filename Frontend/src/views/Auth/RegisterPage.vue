  ...
  methods: {
    ...
    togglePasswordVisibility() {
      ...
      this.passwordToggleIcon =
        this.passwordToggleIcon === 'bi bi-eye-slash' ? 'bi bi-eye' : 'bi bi-eye-slash'
    },
    toggleConfirmPasswordVisibility() {
      this.confirmPasswordFieldType =
        this.confirmPasswordFieldType === 'password' ? 'text' : 'password'
      this.confirmPasswordToggleIcon =
        this.confirmPasswordToggleIcon === 'bi bi-eye-slash' ? 'bi bi-eye' : 'bi bi-eye-slash'
    }
  }
}
</script>
