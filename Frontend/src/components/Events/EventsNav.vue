  ...
  <div>
    <div class="container">
      <ul class="nav nav-tabs">
        <li class="nav-item">
          <a
            :class="{ 'nav-link': true, active: currentService === 'Ticketing' }"
            aria-current="page"
            @click="showService('Ticketing')"
          >
            Ticketing
          </a>
        </li>
        ...
        <li class="nav-item">
          <a
            :class="{ 'nav-link': true, active: currentService === 'BookingSettings' }"
            aria-current="page"
            @click="showService('BookingSettings')"
          >
            Booking Settings</a
          >
        </li>
