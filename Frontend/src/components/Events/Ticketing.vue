      ...
      <div class="col-lg-5 col-md-12 col-sm-12 mb-4">
        <div class="container">
          ...
          <div class="form-floating input-group mb-3">
            ...
            <button @click="updatePrice" class="btn btn-outline-secondary" type="button">
              Update
            </button>
          ...
          <div class="form-floating input-group mb-3">
            <input
              v-model="event_capacity"
              type="text"
              class="form-control"
              placeholder="Special Label"
            />
            <button @click="updateEventCapacity" class="btn btn-outline-secondary" type="button">
              Update
            </button>
  ...
  methods: {
    async updatePrice() {
      try {
        const response = await axios.put(
          `${this.API_URL}update-ticket/${this.ticketId}`,
          { price: this.price },
          {
            headers: {
    ...
    handelErrorToast() {
      Swal.fire({
        ...
        text: 'Error updating event Capacity'
      })
    },
    handelSuccessToast() {
      Swal.fire({
