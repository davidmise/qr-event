...
//             'role' => 'required|in:admin,host,doorman' // Validation rule to ensure the role is one of these values
//         ];
...
//             'role' => $request->input('role'), // Validation rule to ensure the role is one of these values
//         ]);
//         $user->save();
